...
type SignUpUserFunc = (arg: { email: string, password: string, username: string }, dispatch: Dispatch) => void;
...
export type {LogUserInFunc, LogUserOutFunc, GetUserDataFunc, EditUserFunc, SignUpUserFunc};
